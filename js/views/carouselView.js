class AssortmentView {
  ...
  #insertCardInfo(randomNumber, i) {
    ...
    let html = `
      <a productId="${current.id}" class="card carousel__card" aria-label="card" item="priklad" like="${current.like}" bookmark="${current.bookmark}" href="${current.family}/index.html#${current.type}">
